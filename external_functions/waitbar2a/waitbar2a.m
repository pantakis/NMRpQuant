...
%   Ross L. Hatton   08-17-15 [Fixed detection of gui handles for 2014b or
%   later matlab] 
...
function draw_progress_bar(f,h,x)
	...
	p       = patch(xprogress, yprogress, p_color, 'Tag', 'progress', 'EdgeColor', 'none','Parent',h);
	l       = patch(xbackground, ybackground, 'w', 'Tag', 'background', 'FaceColor', 'none', 'EdgeColor', l_color, 'Parent',h);
